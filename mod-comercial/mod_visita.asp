...
<form action="modificar_visita.asp" method="post" name="form_mod_vi" id="form_mod_vi" class="form-horizontal" role="form" onsubmit="return validacionmodvisita()">
	...
	<input type="hidden" class="form-control" id="modv_pre" name="modv_pre" value="<%=pre%>">
	<div class="from-group pull-right col-lg-4" id="div_comercial">
		<label>Comercial Asignado</label>
		<select class="form-control" id="modv_com" name="modv_com" onchange= "location.href='mod_visita.asp?id=' + form_mod_vi.modv_ges_com_id.value + '&contacto=' + form_mod_vi.modv_nomcto.options[form_mod_vi.modv_nomcto.selectedIndex].value + '&cliente=' + form_mod_vi.modv_idcli.value + '&com_asignado=' + form_mod_vi.modv_com.options[form_mod_vi.modv_com.selectedIndex].value + '&estado=' + form_mod_vi.modv_estado.options[form_mod_vi.modv_estado.selectedIndex].value + '&presupuesto=' + form_mod_vi.modv_pre.value + '&fecha=' + form_mod_vi.modv_fecha.value + '&hora=' + form_mod_vi.modv_hora.value + '&des=' + form_mod_vi.modv_desc.value">
	...
	<div class="form-group col-lg-4">
		...
		<button type="button" class="btn btn-info" onclick="window.location.href='presupuesto.asp?id=' + form_mod_vi.modv_ges_com_id.value + '&contacto=' + form_mod_vi.modv_nomcto.options[form_mod_vi.modv_nomcto.selectedIndex].value + '&cliente=' + form_mod_vi.modv_idcli.value + '&com_asignado=' + form_mod_vi.modv_com.options[form_mod_vi.modv_com.selectedIndex].value + '&estado=' + form_mod_vi.modv_estado.options[form_mod_vi.modv_estado.selectedIndex].value + '&fecha=' + form_mod_vi.modv_fecha.value + '&hora=' + form_mod_vi.modv_hora.value + '&des=' + form_mod_vi.modv_desc.value">
