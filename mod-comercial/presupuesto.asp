...
<body>
   ...
   id_visita=request.querystring("id")
   cliente=request.querystring("cliente_nom")
...
<div class="container">
<form action="presupuesto.asp" method="POST" name="form_busq_pre" id="form_busq_pre" class="form-horizontal" role="form" onsubmit="return false">
  <input type="hidden" id="bus_nomcli1" maxlength="50" name="bus_nomcli1" value="<%=bus_nomcli%>">
  <input type="hidden" id="id1" maxlength="50" name="id1" value="<%=id%>">
  <input type="hidden" id="id_visita" maxlength="50" name="id_visita" value="<%=id_visita%>">
  <input type="hidden" id="cliente1" maxlength="50" name="cliente1" value="<%=cliente%>">
  <input type="hidden" id="tlf1" maxlength="50" name="tlf1" value="<%=tlf%>">
  <input type="hidden" id="contacto1" maxlength="50" name="contacto1" value="<%=contacto%>">
  <input type="hidden" id="cto_nom1" maxlength="50" name="cto_nom1" value="<%=cto_nom%>">
  <input type="hidden" id="com_asignado1" maxlength="50" name="com_asignado1" value="<%=com_asignado%>">
  <input type="hidden" id="estado1" maxlength="50" name="estado1" value="<%=estado%>">
  <input type="hidden" id="est_nom1" maxlength="50" name="est_nom1" value="<%=est_nom%>">
  <input type="hidden" id="fecha1" maxlength="50" name="fecha1" value="<%=fecha%>">
  <input type="hidden" id="hora1" maxlength="50" name="hora1" value="<%=hora%>">
   <input type="hidden" id="desc" maxlength="50" name="desc" value="<%=des%>">
    <input type="hidden" id="numero" maxlength="50" name="numero" value="<%=num%>">
